export default function Title1({title}:any) {
  return (
    ...
    <div className="flex w-full mx-auto text-left">
      <div className="relative inline-flex items-center mx-auto align-middle">
        <div className="text-center">
          ...
          {/* <p className="max-w-xl mx-auto mt-8 text-base leading-relaxed text-gray-500">Free and Premium themes, UI Kit&lsquo;s, templates and landing pages built with Tailwind CSS, HTML &amp; Next.js.</p> */}
