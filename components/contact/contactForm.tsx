...
const ContactForm = () => {
    return (
        <section className=" mt-6 dark:bg-slate-800 z-20" id="contact">
        ...
        <div className="flex items-stretch justify-center">
            <div className="grid md:grid-cols-2">
                <div className="h-full pr-6">
                    ...
                    Welcome to Kraiwa Solutions – where your ideas meet innovation! Ready to turn your ideas into reality? Contact us today and let&lsquo;s embark on a journey of innovation, creativity, and success together. Your vision, our expertise – the perfect partnership!
                    </p>
                    <ul className="mb-6 md:mb-0">
                        ...
                        <li className="flex">
                            ...
                            <div className="ml-4 mb-4">
                                ...
                                <a href='tel:+1 571 245 9013' className="text-gray-600 dark:text-slate-400">Mobile: +1 571 245 9013
                                </a>
                                <p className="text-gray-600 dark:text-slate-400">Mail: info@kraiwa.com</p>
                            </div>
                        </li>
                        <li className="flex">
                            <div className="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
